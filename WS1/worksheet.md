...
|  Camera+ribbon cable | x1 		| RS | 913-2664 |
|  Raspberry PI enclosure | x1		| RS |  |
|  330 Ohm resistors 	  | x4		| RS | 125-1157 |
|  DesignSpark case 	  | x1		| RS | 167-7048 |
...
Other items which are not included but useful

|  Item              |  Number  	| Provider  |  Order code |
| ------------------ | -------- 	| --------  | -------- |
|  Component box 	  | x1		| RS | 388-4823 |
|  Spare ribbon cable 	  | x1		| RS | 122-2533 |
|  Power switch 	  | x1		| RS | 440-6979 |
